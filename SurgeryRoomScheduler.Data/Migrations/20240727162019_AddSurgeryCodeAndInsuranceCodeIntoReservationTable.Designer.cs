...
namespace SurgeryRoomScheduler.Data.Migrations
{
    ...
    [Migration("20240727162019_AddSurgeryCodeAndInsuranceCodeIntoReservationTable")]
    partial class AddSurgeryCodeAndInsuranceCodeIntoReservationTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SurgeryRoomScheduler.Domain.Entities.General.ReservationConfirmation", b =>
                {
                    ...
                    b.Property<string>("RejectionAndCancellationAdditionalDescription")
                        .HasMaxLength(5000)
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid?>("RejectionAndCancellationUserId")
                        .HasColumnType("uniqueidentifier");
