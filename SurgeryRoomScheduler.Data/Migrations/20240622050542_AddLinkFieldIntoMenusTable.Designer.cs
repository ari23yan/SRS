...
namespace SurgeryRoomScheduler.Data.Migrations
{
    ...
    [Migration("20240622050542_AddLinkFieldIntoMenusTable")]
    partial class AddLinkFieldIntoMenusTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            modelBuilder
                ...
                .HasAnnotation("Relational:MigrationHistoryTableSchema", "Common");
            ...
            modelBuilder.Entity("SurgeryRoomScheduler.Domain.Entities.General.Reservation", b =>
                {
                    b.HasOne("SurgeryRoomScheduler.Domain.Entities.General.Doctor", "Doctor")
                        .WithMany()
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SurgeryRoomScheduler.Domain.Entities.General.Room", "Room")
                        .WithMany()
            ...
            modelBuilder.Entity("SurgeryRoomScheduler.Domain.Entities.General.Timing", b =>
                {
                    b.HasOne("SurgeryRoomScheduler.Domain.Entities.General.Doctor", "AssignedDoctor")
                        .WithMany()
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SurgeryRoomScheduler.Domain.Entities.General.Room", "AssignedRoom")
                        .WithMany()
                        .HasForeignKey("RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
