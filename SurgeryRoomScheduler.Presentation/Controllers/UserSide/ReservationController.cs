...
namespace SurgeryRoomScheduler.Presentation.Controllers.UserSide
{
    public class ReservationController : BaseController
    {
        ...
        [HttpPost]
        //[PermissionChecker(Permission = PermissionType.Admin_GetReservations)]
        public async Task<IActionResult> CancelReservation(CancelReservationDto request)
        {
            try
            {
                var currentUser = UtilityManager.GetCurrentUser(_httpContextAccessor);
        ...
        [HttpGet]
        //[PermissionChecker(Permission = PermissionType.GetDoctorReservedList)]
        public async Task<IActionResult> GetInsuranceList([FromQuery] string searchKey)
        {
            try
            {
                var result = await _reservationService.GetInsuranceList(searchKey);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpGet]
        //[PermissionChecker(Permission = PermissionType.GetDoctorReservedList)]
        public async Task<IActionResult> GetSurgeryNamesList([FromQuery] string searchKey)
        {
            try
            {
                var result = await _reservationService.GetSurgeryNamesList(searchKey);
                return Ok(result);
            }
            catch (Exception ex)
            {
